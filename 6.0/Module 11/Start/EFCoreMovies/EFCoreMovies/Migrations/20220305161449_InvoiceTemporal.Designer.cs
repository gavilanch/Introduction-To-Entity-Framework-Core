...
namespace EFCoreMovies.Migrations
{
    ...
    [Migration("20220305161449_InvoiceTemporal")]
    partial class InvoiceTemporal
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCoreMovies.Entities.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable(tb => tb.IsTemporal(ttb =>
                        {
                            ttb.UseHistoryTable("InvoicesHistoryTbl");
                            ttb
                                .HasPeriodStart("From")
                                .HasColumnName("From");
                            ttb
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            CreationDate = new DateTime(2022, 1, 24, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            InvoiceNumber = 0
                        },
                        new
                        {
            ...
            modelBuilder.Entity("EFCoreMovies.Entities.InvoiceDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCoreMovies.Entities.CardPayment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 3,
                            Amount = 15.99m,
                            PaymentDate = new DateTime(2022, 2, 21, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PaymentType = 2,
                            Last4Digits = "4567"
                        },
                        new
                        {
                            Id = 4,
                            Amount = 19m,
                            PaymentDate = new DateTime(2022, 2, 22, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PaymentType = 2,
                            Last4Digits = "1111"
                        });
                });
            ...
            modelBuilder.Entity("EFCoreMovies.Entities.InvoiceDetail", b =>
                {
                    b.HasOne("EFCoreMovies.Entities.Invoice", null)
                        .WithMany()
